...
module.exports = {
  ...
  apps: {
    ...
    'ios.release': {
      ...
      build: 'xcodebuild -workspace ios/reactNativeDetox.xcworkspace -scheme reactNativeDetox -configuration Release -sdk iphonesimulator -derivedDataPath ios/build',
    },
    'android.debug': {
      type: 'android.apk',
